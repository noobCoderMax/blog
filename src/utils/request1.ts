...
let temp =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2MzZlMGI3ODk2OGVlY2M1Y2MwYzE2MmQiLCJpYXQiOjE2Njg0MjkwNzIsImV4cCI6MTY2ODUxNTQ3Mn0.SQb3LJV_A9fQYKVlmxjjioBflSW47KkrWMjrHr1GDUc";
...
instance.interceptors.request.use(
  (request: any) => {
    ...
    // (request.xhrFields["withDefaults"] = true);
