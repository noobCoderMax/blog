<template>
  ...
  <div class="countShow" style="margin-top: 20px">
    已完成代办项数量:&nbsp;&nbsp;{{
      todos.isFinishLength <= 0 ? 0 : todos.isFinishLength
    }}&nbsp;&nbsp;项
  </div>

  <div style="margin-top: 20px">
    <el-button>清除选择的已完成代办</el-button>
  </div>
</template>
...
const finishList = todos.finishedList;
console.log(todos.finishedList);
</script>
